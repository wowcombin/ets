  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900/20 to-purple-900/20 text-white">
      ...
      <div className="container mx-auto px-6 py-8">
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            ...
            <CardContent>
              <div className="space-y-3">
                {data.weeklyLeaders.map((leader, index) => (
                  <div key={leader.username} className="flex items-center justify-between p-3 bg-gradient-to-r from-yellow-900/20 to-orange-900/20 rounded-lg border border-yellow-500/30">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-yellow-400">{leader.topCasino}</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="font-bold text-yellow-400">
                        ${leader.weeklyProfit.toFixed(2)}
                      </p>
        ...
        {/* Accounts Activity */}
        {data?.accountsActivity && data.accountsActivity.length > 0 && (
          <Card className="bg-gray-800/50 border-gray-700">
            <CardHeader>
              <CardTitle className="text-white flex items-center gap-2">
            ...
            <CardContent>
              <div className="space-y-3">
                {data.accountsActivity.slice(0, 8).map((account, index) => (
                  <div key={account.username} className="flex items-center justify-between p-3 bg-gray-700/30 rounded-lg border border-gray-600">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">
                          {account.topCasino} • {account.totalTransactions} транзакций
                        </p>
                      </div>
                    </div>
                    <div className="text-right">
